...
json_file = "D:/A/Work/experiments/data/hate_dataset2.json"
class GraphSAGE(torch.nn.Module):                     # CHANGED: class name
	def __init__(self, input_dim, hidden_dim, num_classes):
		super(GraphSAGE, self).__init__()              # CHANGED
		
		self.conv1 = SAGEConv(input_dim, hidden_dim)   # CHANGED
		self.conv2 = SAGEConv(hidden_dim, num_classes) # CHANGED
